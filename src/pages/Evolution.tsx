  ...
  const pieces: Piece[] = [
    {
      ...
      artisticStatement: 'In MOVE, I investigate the physical evolution of human transportation, tracing a kinetic line from the foundational act of walking to the cosmic suspension of a satellite. This work explores how the body\'s energy shifts as our modes of transit accelerate, transitioning from organic, grounded movements into the sharper, more rhythmic textures of modern technology. Central to this narrative is a collaboration with composer Jae Sandweg, whose score serves as a vital storytelling engine; together, we utilized sound to reinforce the idea that transportation is not merely a utility, but a profound expression of movement as a whole. By centering the choreography around recurring anchors—the "primal breath" as a symbol of pure humanity and the shoes as our original vessel of travel—I seek to romanticize the mundane mechanics of everyday life. As the performer navigates diverse environments, from the historic marble of Texas museums to the industrial vibration of trains, the dance highlights how specific spaces dictate human behavior. Ultimately, the film honors the ingenuity of human innovation while maintaining a "tiny rock" perspective: a reminder that even as we reach for the stars, we are still small beings defined by the same breath and bone that carried us through our very first steps.',
      artists: [
        { name: 'Elyse Rosario', role: 'choreographer', bio: 'Elyse Rosario is so excited to present her first dance film at Evolution 2026. Her previous choreography includes: Crisol (2025), Her Testimony, Our Story (2025), as well as multiple performances as co-president of UT\'s Front \'N Center dance organization. She would like to thank everyone who\'s helped put together this film and this event, and she hopes that everyone enjoys everyone\'s pieces!' },
        { name: 'Jae Sandweg', role: 'composer', bio: 'Jae Sandweg is an Arts and Entertainment major with a certificate in Museum Studies with aspirations to become a game designer. Through this project, they hope to explore the components of environments and their sounds to better understand how they contribute to the tone and atmosphere and how that can be applied to video games.' }
      ]
    },
    {
      title: 'Molded Flesh',
    ...
    },
    {
      ...
      artisticStatement: 'You know that feeling when the music is just right? When you can turn off your brain because the rhythms are your guide. Where the melodies hold you close, telling you "everything will be alright." Well, what if you could live in this feeling? "So I (we) wanna stay here" is a movement journey of just this – of the magic of musical escape. In three acts, performers explore what it would be like to put on your headphones and escape to a place where freedom is found in community, joy, and rhythm. As you watch, we ask that you let the music hold you, and take the opportunity to embrace the fantasy where our favorite melodies become our world.',
      artists: [
        { name: 'Bryli Lee Jameson', role: 'choreographer', bio: 'Dance artist and storyteller, Bryli Lee Jameson, is a third-year B.F.A in Dance major at The University of Texas at Austin, where she has performed works by Leandre Douglass, Nadia Milad Issa, and Vanessa Anspaugh. From the Dallas, TX area, she has an extensive background in modern, contemporary, and African diasporic dance styles, which she seamlessly weaves together both as a performer and choreographer. Bryli\'s most recent performance credits with Texas Theatre and Dance include Evolution (2024), Cyphers (2024), Equinox (2025), Rooted in Motion (2025) and Equinox (2026).' },
        ...
        { name: 'Heather Kim', role: 'composer', bio: 'Heather Kim is a Junior at UT Austin studying Art & Entertainment Technology. A singer-songwriter and producer rooted in indie and R&B, her work weaves together composition, sound design, and immersive storytelling. Currently based in Austin and Seoul, Heather brings a cross-cultural perspective to everything she creates, from horror film, studio production to large-scale experiential art. Professionally, she is building a career at the intersection of digital experience design, immersive art, and creative technology.' }
      ]
    },
    {
      title: 'Abdere',
      ...
      artists: [
        ...
        { name: 'Madeleine Birmingham', role: 'choreographer', bio: 'Madeleine Birmingham is a lifelong dancer and emerging dance educator in her 3rd year pursuing a B.F.A. in Dance Education at UT. Maddie\'s extensive classical and commercial training has allowed her to work with choreographers such as Claudia Lavista, Meredith Rainey, and Raul Tamez. She began her dance journey in Carrollton, Texas, where she competed and trained for 16 years and has since moved to Austin, where she has had the opportunity to compete and perform on the University of Texas Dance Team, UT Austin\'s Dance Repertory Theater, in various dance films, and teach freelance Drill Team choreography to schools around Texas.' },
        { name: 'Betty Luo', role: 'composer', bio: 'With a varied background in classical music and orchestra, Betty Luo is a fourth year student studying Arts and Entertainment Technology at UT Austin, working to expand her skills as a musician through digital music production. As an artist, she strives to create experiences through a variety of mediums that can evoke strong emotions, carry an impactful message, and inspire people to continue making art.' },
        { name: 'Gloria Jang', role: 'composer', bio: 'Gloria Jang is an artist drawn to the space where creativity and technology meet, using interactive media to explore what it means to genuinely connect. Her work centers on vulnerability, presence, and storytelling—creating experiences that feel personal, even within digital environments. Music production has become a way for her to slow down and listen more closely.' }
      ]
    },
    {
      title: 'Dovetailed',
    ...
    },
    {
      ...
      artists: [
        ...
        { name: 'Catalina Duong', role: 'choreographer', bio: 'Catalina Duong is a third-year B.F.A in Dance and B.S.A in Biology double major also pursuing a Pre-Health Professions Certificate at the University of Texas at Austin. She is from Houston, Texas, where she attended Kinder High School for the Performing and Visual Arts and trained in a variety of dance techniques. Her recent credits with Texas Theatre and Dance include Points of Intersection (2024), CYPHERS (2024), and Equinox (2025). Additional projects she has participated in are Break-In Dance Fest and The Cohen New Works Festival.' },
        { name: 'Spencer Rhodes', role: 'composer', bio: 'Spencer Rhodes is a fourth-year Arts and Entertainment Technology major, also pursuing a certificate in Japanese at the University of Texas Austin. He is from the small town of Lexington, Texas where he participated in both Musical and Theatrical productions for 7 years while attending school there. He then played for the University Orchestra for 3 semesters. He now creates music in his major with his most recent appearance being at Audio Pixel Collider (2025).' }
      ]
    },
    {
      ...
      artists: [
        { name: 'London Lack', role: 'choreographer', bio: 'London Lack is a fourth-year B.F.A. in Dance and a B.A. in Plan II Honors at The University of Texas at Austin. Recent choreographic credits include her student residency work "Shadow Puppets," her contemporary ballet Quiet Tears of Roses, and House Play. She founded the Cauliflower Project, worked as the Performing Arts Editor of Apricity Magazine, and is an active member of The Friar Society. Upon graduation, she will attend the Trinity Laban Conservatory in Greenwich, England to pursue her MFA in Choreography.' },
        { name: 'Jake Nichols', role: 'composer', bio: 'Jake Nichols is a senior AET student at the University of Texas at Austin. As a passionate musician, he has spent the past few years honing his craft in both performance and audio production. With a strong foundation in mixing, mastering, and recording, he has had the opportunity to use his musical and technical knowledge to create high-quality sounds and performances. He is always eager to collaborate with creative professionals and contribute to exciting projects, whether in a studio setting or on stage.' }
      ]
    },
    {
      ...
      artisticStatement: '"And learn, too late, they grieved it on its way" — The process of grief is a tumultuous path often forged in movements we\'ve already completed. It steals, it molds, and it changes. But who do we become? How do we learn how to move on? Against the Dying Light is the physical manifestation of the scars that loss leaves. Inspired by the poem \'Do Not Go Gentle Into That Good Night\' and the death that has plagued my life since I was a little girl, I explore my own cycles of grief. The distortion of once untouched memories and the dissonance when they no longer feel like mine. What it means to plead for someone to stay alive when you know they are already gone. The denial, the anger, the depression, the isolation, and the acceptance, not that things will be okay but that you will forever carry a chip on your shoulder. How do we hold onto the innocence of memories when death stains them? There is no resolution, only a reflection. An understanding of what is, what has been lost, and what remains. I ask you to reflect on your own life and to please, always remember: Do not go gentle into that good night, and please always, rage, rage against the dying of the light.',
      artists: [
    ...
    },
    {
      ...
      artists: [
        { name: 'Valentina Reyes Rubio', role: 'choreographer', bio: 'Valentina Reyes Rubio is a senior B.F.A. Dance major at the University of Texas at Austin. Born in Bogotá, Colombia, she began her training in Latin rhythms, street dance, and contemporary technique. She performed with AAINJAA, a multidisciplinary company, touring internationally as a featured dancer (2015-2021). She also danced with DanceHolic Project, competing in national competitions in Colombia from 2017 to 2022. At UT Austin, her credits include Cohen New Works Festival, Evolution (2023–2024), Fall for Dance (2023), Cyphers & ACDA (2024–2025), and Rooted in Motion (2025). She presented her choreographic work KILELE in 2025 for Cohen NWF.' },
        { name: 'Emma Lou Flores', role: 'choreographer', bio: 'Emma Lou Flores is a community leader who works as a choreographer and executive board member for student organizations Redefined Dance Company and ATX The Space. Moving between many mediums, she participates in competitive dance, concert dance, and the Austin freestyle/street dance community. She is focused on increasing the unity and accessibility of her communities through redefining the binaries that separate them, finding ways to integrate these individual techniques and cultures. Her choreography shines through musicality and exquisitely precise execution of articulate movements with mechanical melodic aspects.' },
    ...
    },
    {
      ...
      artisticStatement: 'Marrow explores the intricate patterns of indulgence, sacrifice, and shedding within our relationships. It questions the temptations we surrender to and how they ultimately define who we become. In the attempt to hide our true selves, we often inadvertently expose our deepest vulnerabilities.',
      artists: [
        { name: 'Katelyn Doyle', role: 'choreographer', bio: 'Katelyn Doyle is a junior at The University of Texas at Austin pursuing a BFA in Dance and a BA in English. Originally from Dallas, Texas, she trained at Avant Chamber Ballet and Booker T. Washington High School for the Performing and Visual Arts. Her recent credits with Texas Theatre and Dance include Cabaret (2025), Equinox (2025 and 2024), and Cyphers (2024). In 2025, she also choreographed for The Cohen New Works Festival.' },
        { name: 'Lauren Dorsett', role: 'choreographer', bio: 'Lauren Dorsett is a third-year B.F.A in Dance and B.S. in Kinesiology and Exercise Science major pursuing the Pre-Physical Therapy track at the University of Texas at Austin. She is from Katy, Texas, where she trained in a variety of dance techniques. Her recent credits with Texas Theatre and Dance include Points of Intersection (2024), CYPHERS (2024), and Equinox (2025). Additional projects she has participated in are The Cohen New Works Festival and Break-In Dance Fest.' },
        { name: 'Jake Nichols', role: 'composer', bio: 'Jake Nichols is a senior AET student at the University of Texas at Austin. As a passionate musician, he has spent the past few years honing his craft in both performance and audio production. With a strong foundation in mixing, mastering, and recording, he has had the opportunity to use his musical and technical knowledge to create high-quality sounds and performances.' },
        { name: 'Gloria Jang', role: 'composer', bio: 'Gloria Jang is an artist drawn to the space where creativity and technology meet. She is interested in organic textures and emotional nuance, shaping sound into moments that invite reflection, intensity, and honesty. As she continues to grow, she hopes to move fluidly across different mediums, using each as a way to better understand herself and others, and to create spaces where people feel seen, present, and connected.' }
      ]
    },
    {
      title: 'Least of You',
    ...
    },
    {
      ...
      artisticStatement: 'Still, Then Again is a moving representation of the connections between mind and body, focusing on the tension between self-observation and the feeling of being watched. The accompanying music conveys a sense of repetition, intimacy, and sensuality, painting an image of a winter garden or wooded environment. It incorporates ambient, evolving, and natural textures to highlight the unique authenticity found in private movement and performance. The music engages with the camerawork in the film to emphasize moments of interruption. This amplifies the idea of remaining grounded in an internal, sensual experience even while under external scrutiny.',
      artists: [
        { name: 'Rheana Sanders', role: 'composer', bio: 'As a former pianist, Rheana has experience in making a variety of melodies, particularly those in minor keys. She is also an intermediate Ableton and BandLab user, with some familiarity with Reaper. She hopes to expand her knowledge of music-making, effective collaboration, and DAWs through this project.' },
        { name: 'Kel Shang', role: 'composer', bio: 'Kel Shang is a senior Arts & Entertainment Technologies and Economics student. Specializing in creative research and storytelling, Kel Shang had the opportunity to expand her background composing sound narratives on a multimedia film collaboration for Evolution 2026. Professionally, Kel is interested in promoting the next generation of fine arts through emerging technologies in educational and instructional spaces. She is experienced with audio editing in Adobe Premiere Pro and grew her knowledge in audio composition using Ableton.' }
      ]
    }
  ];
