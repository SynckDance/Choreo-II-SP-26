        ...
        <div className="lab-body">
          {modules.length > 0 ? (
            ...
            <div className="empty-state">
              <div className="empty-state-icon">{labInfo.icon}</div>
              <div className="empty-state-title">Modules coming soon</div>
              <div className="empty-state-desc">
                Content will be added as we progress through the semester.
              </div>
            </div>
          )}
        </div>
